...
- Troubleshooting: You MUST document all encountered errors, their solutions, and relevant best practices in [docs/troubleshooting.md](./docs/troubleshooting.md) to facilitate team learning and speed up future debugging.
